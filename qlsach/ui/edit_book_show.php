...
<body>
    <form id="form-edit" action="" method="POST">
        <h2 class="h2">Sửa thông tin sách</h2>
        ...
        <button class="button" type="submit" id="save-btn">Lưu thay đổi</button>
        <button class="button-x" type="button" id="back-btn">Hủy chỉnh sửa</button>
        <button class="button-x dnone" type="button" id="cancel-btn">Xóa thông tin</button>
    </form>

    <script>window.editBookSuccess = <?= json_encode($edit_success) ?>;</script>
